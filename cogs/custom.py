...
class CustomCog(commands.Cog):
    ...
    # async def custom(self, ctx: CustomContext):
    ...
    @commands.command(
        help="Bonk.")
    async def cbonk(self, ctx: CustomContext, member: discord.Member = None):
    ...
    async def hungry(self, ctx: CustomContext):
    ...
    async def stars(self, ctx: CustomContext):
    ...
    async def luck(self, ctx: CustomContext, member: discord.Member = None):
        if member is None:
            if ctx.message.reference:
                member = ctx.message.reference.resolved.author
            else:
    ...
    async def jason(self, ctx: CustomContext):
    ...
    async def fast(self, ctx: CustomContext):
    ...
    async def weird(self, ctx: CustomContext, member: discord.Member = None):
        if member is None:
            if ctx.message.reference:
                member = ctx.message.reference.resolved.author
            else:
    ...
    async def fact(self, ctx: CustomContext, member: discord.Member = None):
        if member is None:
            if ctx.message.reference:
                member = ctx.message.reference.resolved.author
            else:
    ...
    async def lie(self, ctx: CustomContext, member: discord.Member = None):
        if member is None:
            if ctx.message.reference:
                member = ctx.message.reference.resolved.author
            else:
    ...
    async def cha(self, ctx: CustomContext):
    ...
    async def pingender(self, ctx: CustomContext):
    ...
    @commands.command(
        help="Cries")
    async def cry(self, ctx: CustomContext):
        await ctx.send(f"😢😢😢😢😢😢😢😢😢😢")

    # <@748105241857097759>

    @commands.command(description="Sends a GIF of a man eating a burger")
    async def burger(self, ctx: CustomContext):
    ...
    @commands.command(
        help="Replies with e")
    async def e(self, ctx: CustomContext):
        await ctx.send(f"e")
    ...
    @commands.command(
        help="EA Sports")
    async def ea(self, ctx: CustomContext):
    ...
    async def nou(self, ctx: CustomContext):
    ...
    @commands.command(
        ...
        aliases=["h"])
    async def hello(self, ctx: CustomContext):
    ...
    @commands.command(
        help="idiot")
    async def me(self, ctx: CustomContext):
